...
if %errorlevel%==2 (
    ...
    pause
    rem curl -L -o Minecraft-辅助命令脚本_Download.bat --ssl-no-revoke https://raw.githubusercontent.com/Dong8jing8yu/Dong8jing8yu.github.io/main/
    rem .Minecraft-辅助命令脚本_Download.bat
)
if %errorlevel%==3 (
        echo.还没有找到好的网站呢
        pause
